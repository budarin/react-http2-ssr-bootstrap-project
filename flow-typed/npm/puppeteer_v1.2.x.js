...
declare module 'puppeteer' {
    ...
    declare type BrowserEvents = 'disconnected' | 'targetchanged' | 'targetcreated' | 'targetdestroyed';
    ...
    declare type PDFFormat = 'Letter' | 'Legal' | 'Tabload' | 'Ledger' | 'A0' | 'A1' | 'A2' | 'A3' | 'A4' | 'A5';
    ...
    declare interface Page extends OverridableEventEmitter, FrameBase {
         ...
         */
        exposeFunction(name: string, puppeteerFunction: (...args: Array<mixed>) => mixed): Promise<void>;
